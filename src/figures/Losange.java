 ...
 * Classe qui cree des losanges, elle herite de Polygone
 *
 */
...
public class Losange extends Polygone {
	...
	/**
	 * constructeur qui prend en parametre une array liste le premier point
	 * donne le centre du losange le second point determine l'angle du losange
	 * ainsi que la taille des cotes
	 * 
	 * @param listePointsSaisie
	 *            (doit contenir au minimum 2 points)
	 */
